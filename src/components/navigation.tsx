              ...
              <div className="flex flex-col space-y-4 mt-8">
                {navigation.map((item) => {
                  ...
                  return (
                    <Button
                      ...
                      variant="ghost"
                      asChild
                      className={`text-sm font-medium transition-all duration-300 justify-start rounded-3xl px-6 py-3 bg-white/90 text-black hover:bg-white shadow-md hover:shadow-lg ${
                        isActive ? "border-4" : "border-2"
                      }`}
                      style={{
                        borderColor: borderColor,
                ...
                <div className="pt-4 border-t border-white/20">
                  {isLoggedIn ? (
                    ...
                    <Button asChild className="w-full rounded-3xl px-8 py-3 border-2 border-transparent hover:border-white/40 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl overflow-hidden relative bg-gradient-to-r from-[#146C94] via-[#19A7CE] to-[#146C94] hover:from-[#19A7CE] hover:via-[#0f4a61] hover:to-[#19A7CE]">
